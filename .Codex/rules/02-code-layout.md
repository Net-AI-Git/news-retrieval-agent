...
- Shared infra: `redis_repository.py`, `opensearch_repository.py` in `repositories/`.
...
- **Prompts** → external files under `prompts/` only. No authored prompt text in Python code. Full prompt standards → [`prompts/AGENTS.md`](../../project/src/prompts/AGENTS.md).
