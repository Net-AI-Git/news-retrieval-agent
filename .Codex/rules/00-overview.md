...
4. [`04-error-and-logging.md`](04-error-and-logging.md) — Phase 3: single try/except pattern, OpenTelemetry logging, no silent failures. Apply **after code works (hardening)**.
