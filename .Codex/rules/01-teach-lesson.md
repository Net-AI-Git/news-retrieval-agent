...
- **Local structured log** → [`04-error-and-logging.md`](04-error-and-logging.md) → [`logging_repository.py`](../../project/src/repositories/logging_repository.py:1).
- **Local agent telemetry** → [`04-error-and-logging.md`](04-error-and-logging.md) Section 8 → [`telemetry_repository.py`](../../project/src/repositories/telemetry_repository.py:1) → [`orchestration/AGENTS.md`](../../project/src/orchestration/AGENTS.md:1) → [`agents/AGENTS.md`](../../project/src/agents/AGENTS.md:1) → [`tools/AGENTS.md`](../../project/src/tools/AGENTS.md:1).
- **Local log audit or dashboard** → [`logging_audit_client.py`](../../project/observability/logging_audit/logging_audit_client.py:1) (`logs` SQL view) → [`build_dashboard.py`](../../project/observability/logging_dashboard/build_dashboard.py:1) → [`04-error-and-logging.md`](04-error-and-logging.md).
