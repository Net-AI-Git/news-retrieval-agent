...
- **OpenTelemetry log** → [`04-error-and-logging.md`](04-error-and-logging.md) → [`opensearch_repository.py`](../../project/src/repositories/opensearch_repository.py:1).
- **Monitor (OpenSearch PPL query)** → [`opensearch_repository.py`](../../project/src/repositories/opensearch_repository.py:1) (`get_data_from_opensearch`, `publish_metrics`) → [`04-error-and-logging.md`](04-error-and-logging.md).
