...
**Status:** Superseded — 2026-08-28. Prompt-only Gather (decompose + `search_facts` in one agent) is closed. Production split: Gather emits sub-questions; retrieve fills `source` / dates and calls the tool. Chunk score for that split is **Done** (2026-08-29): [`gate4-gather-gold-chunks-prompt-goal.md`](gate4-gather-gold-chunks-prompt-goal.md). Working log: [`pda-knowledge-retrieval-assignment/TASK-04-decisions.md`](pda-knowledge-retrieval-assignment/TASK-04-decisions.md) “Gather first-hop gold chunks”. First-hop board still lives under `tests/live_gather_first_hop/`.  
**Author:** N/A  
**Created:** 2026-08-28  
