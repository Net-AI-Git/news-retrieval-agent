...
| How this service writes, queries, and visualizes local logs | [`logging.md`](logging.md#L1) | the team |
...
├── logging.md                   ← JSONL storage + SQLite query conventions
...
- **Before touching local logging** → read [`logging.md`](logging.md#L1); the event field shape there is the contract.
