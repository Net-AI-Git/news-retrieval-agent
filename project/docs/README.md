...
| How this service sends OpenTelemetry logs to / queries OpenSearch | [`opensearch.md`](opensearch.md#L1) | the team |
...
├── opensearch.md                      ← OTLP ingestion + PPL query conventions
...
- **Before touching OpenTelemetry logging** → read [`opensearch.md`](opensearch.md#L1); the event field shape there is the contract.
