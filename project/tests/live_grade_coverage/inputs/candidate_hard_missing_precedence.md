...
- Return empty_stop only when every need was searched and evidence is wholly unrelated, or directly addresses the required outlet and event but omits the requested answer.
