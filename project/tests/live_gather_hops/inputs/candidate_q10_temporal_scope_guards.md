...
- A week, season, date, or other scope phrase belongs only to the event clause that contains it. Never copy that scope onto a sibling event unless the user repeats it there.
