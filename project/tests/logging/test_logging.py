...
class LoggingTests(unittest.TestCase):
    ...
    def test_dashboard_is_self_contained(self):
        ...
        self.assertIn("btn-errors", dashboard_html)
        self.assertIn("btn-agents", dashboard_html)
        self.assertIn("btn-questions", dashboard_html)
        self.assertIn("btn-cost", dashboard_html)
        self.assertIn("class='purpose'", dashboard_html)
        self.assertIn("class='caption'", dashboard_html)
        self.assertIn("USD summed across all questions, by agent", dashboard_html)
        self.assertIn("USD for one question each", dashboard_html)
        self.assertNotIn("btn-logging", dashboard_html)
        self.assertNotIn("btn-telemetry", dashboard_html)
        self.assertNotIn("Question flows", dashboard_html)
        self.assertIn("GT comparison", dashboard_html)
        self.assertIn("Success percent for the whole exam set", dashboard_html)
