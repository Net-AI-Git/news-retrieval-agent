...
Exercises `src/orchestration/grounded_answering_workflow.py`, `src/agents/gather_agent.py`, `src/agents/answer_agent.py`, `src/schemas/agent.py`, `src/prompts/`, and the retrieval tool surface through a live loop.
