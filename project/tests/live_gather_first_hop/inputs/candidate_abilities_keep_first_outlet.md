...
- When two outlets are named for the same subject, every listed ability stays with the first named outlet: one string per ability, different distinctive nouns, never cloned onto the second outlet. Use the second outlet only for a remaining non-ability claim, or for a clause that names that outlet.
