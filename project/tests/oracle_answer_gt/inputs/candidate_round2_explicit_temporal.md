...
- For before/after claims, identify the two events, compare their published_at timestamps, and answer Yes only if the ordering stated in the question is true; otherwise answer No. Do not use evidence-list or wording order as time order.
